  ...
  while (retries > 0) {
    ...
    try {
      ...
      if (parseInt(presetCount.rows[0].count) === 0) {
        const presets = [
          { name: 'Aria',     category: 'Girls', ethnicity: 'Caucasian', age: '22-26', personality: 'Sweet & Caring',    tagline: 'Your sunshine on a cloudy day',    hair_color: 'Blonde', hair_style: 'Wavy',     eye_color: 'Blue',  body_type: 'Slim',     voice: 'Soft & Gentle',     hobbies: ['Yoga','Reading','Art'],           prompt: 'photorealistic portrait beautiful young woman blonde wavy hair blue eyes warm smile cream sweater golden hour lighting professional photography' },
          { name: 'Luna',     category: 'Girls', ethnicity: 'Latina',    age: '23-27', personality: 'Bold & Confident',  tagline: "Life's an adventure — join me",    hair_color: 'Black',  hair_style: 'Long',     eye_color: 'Brown', body_type: 'Athletic', voice: 'Warm & Rich',       hobbies: ['Dancing','Travel','Fitness'],     prompt: 'photorealistic portrait beautiful young latina woman long dark hair brown eyes confident smile leather jacket urban background' },
          { name: 'Sakura',   category: 'Anime', ethnicity: 'Asian',     age: '20-24', personality: 'Shy & Gentle',      tagline: "Let's share quiet moments",        hair_color: 'Pink',   hair_style: 'Straight', eye_color: 'Green', body_type: 'Petite',   voice: 'Soft & Gentle',     hobbies: ['Art','Music','Gaming'],           prompt: 'anime character portrait cute girl pink straight hair green eyes shy gentle expression pastel school uniform cherry blossom background modern anime art style vibrant colors detailed eyes' },
          { name: 'Emilia',   category: 'Girls', ethnicity: 'Caucasian', age: '24-28', personality: 'Witty & Playful',   tagline: "I'll keep you on your toes",       hair_color: 'Red',    hair_style: 'Curly',    eye_color: 'Green', body_type: 'Curvy',    voice: 'Bright & Cheerful', hobbies: ['Music','Cooking','Photography'],  prompt: 'photorealistic portrait beautiful young woman red curly hair green eyes playful smile white blouse garden background warm lighting' },
          { name: 'Zara',     category: 'Girls', ethnicity: 'African',   age: '22-26', personality: 'Energetic & Fun',   tagline: 'Every day is a celebration',       hair_color: 'Black',  hair_style: 'Curly',    eye_color: 'Brown', body_type: 'Athletic', voice: 'Bright & Cheerful', hobbies: ['Fitness','Dancing','Music'],      prompt: 'photorealistic portrait beautiful young black woman natural curly hair brown eyes radiant smile vibrant yellow top studio lighting' },
          { name: 'Mei',      category: 'Girls', ethnicity: 'Asian',     age: '21-25', personality: 'Sweet & Caring',    tagline: "I'll always be here for you",      hair_color: 'Brown',  hair_style: 'Straight', eye_color: 'Hazel', body_type: 'Slim',     voice: 'Calm & Soothing',   hobbies: ['Reading','Cooking','Art'],        prompt: 'photorealistic portrait beautiful young east asian woman straight brown hair hazel eyes soft warm smile light blue cardigan cafe background' },
          { name: 'Sofia',    category: 'Girls', ethnicity: 'Latina',    age: '25-29', personality: 'Wise & Calm',       tagline: "Let's talk about life",            hair_color: 'Brown',  hair_style: 'Wavy',     eye_color: 'Brown', body_type: 'Curvy',    voice: 'Warm & Rich',       hobbies: ['Photography','Travel','Reading'], prompt: 'photorealistic portrait beautiful young latina woman wavy brown hair brown eyes serene expression earth tone dress golden hour outdoor' },
          { name: 'Nadia',    category: 'Girls', ethnicity: 'Arab',      age: '24-28', personality: 'Mysterious & Deep',  tagline: 'Stargazing and deep talks',        hair_color: 'Black',  hair_style: 'Long',     eye_color: 'Hazel', body_type: 'Slim',     voice: 'Calm & Soothing',   hobbies: ['Travel','Art','Reading'],         prompt: 'photorealistic portrait beautiful young middle eastern woman long dark hair hazel eyes mysterious smile elegant dark clothing dramatic studio lighting' },
          { name: 'Kai',      category: 'Guys',  ethnicity: 'Asian',     age: '25-29', personality: 'Bold & Confident',  tagline: 'Your partner in every adventure',  hair_color: 'Black',  hair_style: 'Short',    eye_color: 'Brown', body_type: 'Athletic', voice: 'Deep & Confident',  hobbies: ['Gaming','Fitness','Music'],       prompt: 'photorealistic portrait handsome young east asian man short black hair brown eyes charming confident smile dark henley shirt urban background' },
          { name: 'Marcus',   category: 'Guys',  ethnicity: 'African',   age: '26-30', personality: 'Warm & Supportive', tagline: "I've got your back, always",        hair_color: 'Black',  hair_style: 'Short',    eye_color: 'Brown', body_type: 'Athletic', voice: 'Deep & Confident',  hobbies: ['Music','Cooking','Travel'],       prompt: 'photorealistic portrait handsome young black man short hair brown eyes genuine friendly smile casual denim jacket outdoor natural lighting' },
          { name: 'Elena',    category: 'Girls', ethnicity: 'Caucasian', age: '23-27', personality: 'Energetic & Fun',   tagline: "Let's make memories together",     hair_color: 'Blonde', hair_style: 'Straight', eye_color: 'Blue',  body_type: 'Athletic', voice: 'Bright & Cheerful', hobbies: ['Fitness','Photography','Dancing'], prompt: 'photorealistic portrait beautiful young woman straight blonde hair blue eyes energetic bright smile athletic casual wear outdoor park background' },
          { name: 'Yuki',     category: 'Anime', ethnicity: 'Asian',     age: '20-24', personality: 'Playful & Energetic',tagline: "Let's make every moment count!",   hair_color: 'White',  hair_style: 'Short',    eye_color: 'Blue',  body_type: 'Petite',   voice: 'Bright & Cheerful', hobbies: ['Gaming','Art','Music'],           prompt: 'anime character portrait energetic girl short white hair bright blue eyes cheerful excited expression colorful casual outfit neon city background modern anime art style vibrant dynamic colors' },
          { name: 'Isabella', category: 'Girls', ethnicity: 'Latina',    age: '24-28', personality: 'Sweet & Caring',    tagline: 'Mi corazón is yours',              hair_color: 'Black',  hair_style: 'Wavy',     eye_color: 'Brown', body_type: 'Curvy',    voice: 'Warm & Rich',       hobbies: ['Cooking','Dancing','Music'],      prompt: 'photorealistic portrait beautiful young latina woman wavy dark hair brown eyes warm sweet smile floral summer dress warm sunset lighting' },
          { name: 'Liam',     category: 'Guys',  ethnicity: 'Caucasian', age: '27-31', personality: 'Witty & Playful',   tagline: 'A gentleman with a wild side',     hair_color: 'Brown',  hair_style: 'Short',    eye_color: 'Green', body_type: 'Athletic', voice: 'Warm & Rich',       hobbies: ['Travel','Cooking','Photography'], prompt: 'photorealistic portrait handsome young man short brown hair green eyes witty confident smirk casual blazer cafe background warm natural lighting' },
          { name: 'Aisha',    category: 'Girls', ethnicity: 'African',   age: '22-26', personality: 'Wise & Calm',       tagline: 'Beauty, brains, and soul',         hair_color: 'Black',  hair_style: 'Curly',    eye_color: 'Brown', body_type: 'Curvy',    voice: 'Calm & Soothing',   hobbies: ['Reading','Yoga','Art'],           prompt: 'photorealistic portrait beautiful young black woman curly natural hair brown eyes wise serene expression elegant earth tones soft studio lighting' },
